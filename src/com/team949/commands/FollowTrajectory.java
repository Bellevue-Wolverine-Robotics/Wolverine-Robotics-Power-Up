...
//	private BobTalonSRX leftTalon = Robot.drivetrain.leftLead;
	private WPI_TalonSRX rightTalon = Robot.driveTrain.r0;
	private WPI_TalonSRX leftTalon = Robot.driveTrain.l0;
	...
	private class BufferLoader implements java.lang.Runnable {
		...
		private int manageBuffer(WPI_TalonSRX talon, SrxMotionProfile prof, int pidfSlot, int lastPointSent) {
